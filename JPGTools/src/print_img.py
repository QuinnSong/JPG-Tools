...
class PrintFrameworkSample(wx.Frame):
    def __init__(self):
        ...
        self.tc = wx.StaticBitmap(self, wx.ID_ANY, wx.BitmapFromImage(self.emptyImg))  
        self.tc.SetFont(wx.Font(FONTSIZE, wx.TELETYPE, wx.NORMAL, wx.NORMAL))
        filename = os.path.join(os.path.dirname(__file__), "dial.png")
        img = wx.Image(filename, wx.BITMAP_TYPE_ANY)
        self.tc.SetBitmap(wx.BitmapFromImage(img))
